  ...
  _createClass(PageViews, [{
    ...
    value: function updateTable() {
      ...
      var totals = {
        ...
        protection: $.i18n('num-protections', datasets.filter(function (page) {
    ...
    value: function massviewsRedirectWithPagePile(pages) {
      ...
      $.ajax({
        ...
        _this10.writeMessage($.i18n('auto-pagepile-error', 'PagePile', 10), 'error');
...
var templates = {
  ...
  tableRow: function tableRow(scope, item) {
    ...
    var tag = last ? 'th' : 'td';
    var historyRow = last ? scope.formatNumber(item.num_edits) : scope.getHistoryLink(item.label, scope.formatNumber(item.num_edits));
