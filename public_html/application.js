      ...
      this.getPageInfo(pages).done(function (data) {
        ...
        _this10.getEditData(Object.keys(data)).done(function (editData) {
          for (var _page in editData.pages) {
            ...
            var protection = (_this10.entityInfo[_page].protection || []).find(function (prot) {
              return prot.type === 'edit';
            });
            pageData.protection = protection ? protection.level : $.i18n('none').toLowerCase();

            Object.assign(_this10.entityInfo[_page], editData.pages[_page]);
          }
        ...
        return datasets.map(function (dataset, index) {
          ...
          dataset.forEach(function (elem) {
            ...
            if (_this4.app === 'metaviews') {
              ...
              date = moment(elem.timestamp, _this4.config.timestampFormat).format('YYYY-MM-DD');
            }
...
var templates = {
  chartLegend: function chartLegend(scope) {
    var dataList = function dataList(entity) {
      ...
      var infoHash = (_infoHash = {}, _defineProperty(_infoHash, $.i18n('pageviews'), (_$$i18n = {}, _defineProperty(_$$i18n, $.i18n('pageviews'), scope.formatNumber(entity.sum)), _defineProperty(_$$i18n, $.i18n('daily-average'), scope.formatNumber(entity.average)), _$$i18n)), _defineProperty(_infoHash, $.i18n('revisions'), (_$$i18n2 = {}, _defineProperty(_$$i18n2, $.i18n('edits'), editsLink), _defineProperty(_$$i18n2, $.i18n('editors'), scope.formatNumber(entity.num_users)), _$$i18n2)), _defineProperty(_infoHash, $.i18n('basic-information'), _defineProperty({}, $.i18n('watchers'), entity.watchers ? scope.formatNumber(entity.watchers) : $.i18n('unknown'))), _infoHash);

      if (!multiEntity) {
        var _Object$assign;

        Object.assign(infoHash[$.i18n('basic-information')], (_Object$assign = {}, _defineProperty(_Object$assign, $.i18n('size'), entity.length ? scope.formatNumber(entity.length) : ''), _defineProperty(_Object$assign, $.i18n('protection'), entity.protection), _Object$assign));
      }
