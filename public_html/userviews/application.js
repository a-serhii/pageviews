  ...
  return function (_superclass) {
    ...
    _createClass(_class, [{
      ...
      value: function renderData(cb) {
        ...
        var newSortClassName = parseInt(this.direction, 10) === 1 ? 'glyphicon-sort-by-attributes-alt' : 'glyphicon-sort-by-attributes';
...
var UserViews = function (_mix$with) {
  ...
  _createClass(UserViews, [{
    ...
    value: function pushParams() {
      ...
      $('.permalink').prop('href', '/userviews?' + $.param(this.getPermaLink()) + '&page=' + escapedPageName);
    }
    ...
    value: function validateProject() {
      ...
      if (_get(UserViews.prototype.__proto__ || Object.getPrototypeOf(UserViews.prototype), 'validateProject', this).call(this, true)) {
...
},{"../shared/chart_helpers":1,"../shared/list_helpers":3,"../shared/pv":5,"../shared/site_map":7,"./config":8}]},{},[9]);
